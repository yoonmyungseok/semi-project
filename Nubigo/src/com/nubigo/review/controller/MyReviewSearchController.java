...
/**
 * Servlet implementation class MyReviewSearchController
 */
@WebServlet("/myReviewSearch.re")
public class MyReviewSearchController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyReviewSearchController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Review> rlist = new ReviewService().showMyReviews(memberNo);
		...
		ArrayList<Review> list = new ReviewService().myReviewSearchList(pi, memberNo, keyword);
		request.setAttribute("pi", pi);
		request.setAttribute("list", list);
		request.setAttribute("keyword", keyword);
		request.getRequestDispatcher("views/review/myReviewSearchList.jsp").forward(request, response);
	}

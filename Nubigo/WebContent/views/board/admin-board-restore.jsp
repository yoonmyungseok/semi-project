    ...
    <div id="wrap" class="container">
        <div class="row">
            ...
            <div class="col-9">
                    ...
                    <form class="form-group row">
                        ...
                        <div class="input-group col-9">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-nubigoMain" type="button" id="button-addon2"><i
                ...
                <div class="d-flex">
                    <button class="btn btn-nubigoMain ml-auto mb-3" id="deleteBoard" disabled>복구</button>
                </div>

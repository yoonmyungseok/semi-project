...
<%@ include file="../common/menubar.jsp" %>
    <div id="wrap">
        ...
        <hr>
        <form action="<%=contextPath %>/insert.bo" method="post" id="board-Enroll" enctype="multipart/form-data">
            <input type="hidden" name="memberNo" value="<%=loginUser.getMemberNo()%>"><!-- value값은 로그인한회원번호나중에 바꿔야함 loginUser.getUserNo() -->
            ...
            <div class="form-group row">
                ...
                <div class="input-group col-10">
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" id="BoardFileUpload" name="upfile">
                        <label class="custom-file-label" for="BoardFileUpload" data-browse="파일 첨부">파일 용량 제한: 30MB</label>
                    </div>
                </div>
            </div>
        <hr>
